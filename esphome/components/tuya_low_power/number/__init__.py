...
from .. import CONF_TUYALOWPOWER_ID, TuyaLowPower, TuyaDatapointType, tuya_low_power_ns
...
TuyaNumber = tuya_low_power_ns.class_("TuyaNumber", number.Number, cg.Component)
